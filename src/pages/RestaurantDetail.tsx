    ...
    <div className="space-y-4">
      ...
      <SectionCard title="Restaurant Survey">
        ...
        <div className="mt-4 grid grid-cols-2 gap-3">
          ...
          <PhotoTile label="Survey Meeting Photo" url={r.meetingPhotoUrl} />
        </div>
      </SectionCard>
    ...
    <div>
      ...
      {url && !failed ? (
        <a href={url} target="_blank" rel="noreferrer">
          <img src={url} alt={label} className="h-32 w-full rounded border border-border object-cover" onError={() => setFailed(true)} />
        </a>
      ) : (
